...
ЧТО ПОДТВЕРЖДЕНО:
ОТК независимо проверил target-коммиты и отсутствие изменения семантики APFS writer. Точная Windows Build для итогового target-коммита завершилась SUCCESS уже после последнего heartbeat работника. Runtime loss также подтверждён GitHub-якорями: последний heartbeat был до stale boundary, а recovery guard сработал позже неё и fenced старое исполнение.

ГДЕ ОСТАНОВИЛСЯ:
Фактическая граница смены — последний heartbeat 19.09.2026 15:53:55 МСК: Windows Build ещё наблюдалась как in_progress. Работник не передавал смену добровольно; выполнение исчезло во время корректного active evidence wait.
